            ...
            <div class="Fav_frame">
                ...
                <div class="nav__menu" id="nav-menu">
                    ...
                    <img src="./images/paint-roller.png" alt="image" class="nav__img-2">
                        ...
                        </div>`,e}function Ae(){document.querySelector(".nav.container").querySelectorAll("a").forEach(a=>{a.style.cursor="pointer",a.addEventListener("click",n=>{n.preventDefault(),console.log(`${a.innerHTML} clicked!`),f(a.getAttribute("dest"))})}),h()}window.addEventListener("hashchange",()=>{console.log("hash change",location.hash),v()});document.addEventListener("DOMContentLoaded",()=>{Oe(),location.hash?v():location.hash="/",window.addEventListener("scroll",Se);const e=document.querySelector("#footer>a");e.addEventListener("click",()=>{f(e.getAttribute("dest"))})});function Oe(){const e=document.getElementById("header");e.innerHTML="",e.appendChild(we()),Ae()}function Se(){const e=document.getElementById("header");window.scrollY>=50?e.classList.add("blur_header"):e.classList.remove("blur_header")}
